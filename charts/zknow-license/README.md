...
To install the chart with the release name `zknow-license`:

```console
$ helm repo add c7n https://openchart.choerodon.com.cn/choerodon/c7n
$ helm repo update
$ helm install zknow-license c7n/zknow-license
```
...
| image.repository | string | `"c7n/zknow-license"` | service image repository |
